...
const {
  platforms: { boofyfinance, equalizer },
  tokens: {
    //ETH: { address: ETH },
   // USDCe: { address: USDCe },
    EQUAL: { address: EQUAL },
...
const strategyParams = {
  ...
  swapper: boofyfinance.boofySwapper,
  ...
  feeConfig: boofyfinance.boofyFeeConfig,
  verifyStrat: false,
  rewards: [EQUAL],
  boofyVaultProxy: boofyfinance.vaultFactory,
  stratFactory: boofyfinance.strategyFactory,
