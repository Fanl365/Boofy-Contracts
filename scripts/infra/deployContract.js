...
const {
  ...
  const boofyFeeConfig = "0x2b0C9702A4724f2BFe7922DB92c4082098533c62";

const ethers = hardhat.ethers;

const contractName = "StrategySiloV2";
const factoryName = "BoofyVaultV7Factory";
...
async function main() {
  ...
  //console.log(native, boofyfinance.keeper, boofyfinance.boofyFeeRecipient, boofyFeeConfig)
