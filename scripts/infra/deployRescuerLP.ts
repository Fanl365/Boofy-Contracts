...
const {
  platforms: { quickswap, boofyfinance },
} = addressBook.polygon;
...
async function main() {
  ...
  const Rescuer = await ethers.getContractFactory("BoofyRescuerLP");
  ...
  await rescuer.transferOwnership(boofyfinance.strategyOwner);
