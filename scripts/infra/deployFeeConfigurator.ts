...
const contractNames = {
  BoofyFeeConfigurator: "BoofyFeeConfigurator",
};
...
const deploy = async () => {
  const BoofyFeeConfiguratorFactory = await ethers.getContractFactory(contractNames.BoofyFeeConfigurator)

  console.log("Deploying:", contractNames.BoofyFeeConfigurator);
  ...
  console.log(`Implementation address (${contractNames.BoofyFeeConfigurator}):`, implementationAddress);
  ...
  if (shouldVerifyOnEtherscan) {
    console.log(`Verifying ${contractNames.BoofyFeeConfigurator}`);
