...
import BoofyOracleAbi from "../../data/abi/BoofyOracle.json";
...
const boofyfinanceOracle = boofyfinance.boofyOracle;
...
const uniswapV2Oracle = boofyfinance.boofyOracleUniswapV2;
...
async function setOracle(token, oracle, data) {
  ...
  const oracleContract = await ethers.getContractAt(BoofyOracleAbi, boofyfinanceOracle, keeper);
