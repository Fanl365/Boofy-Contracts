...
contract BoofyRewardRescue {
    ...
    IBoofySwapper public boofySwapper = IBoofySwapper(0x0000830DF56616D58976A12D19d283B40e25BEEF);
    ...
    constructor() {
        silo.approve(address(boofySwapper), type(uint).max);
    }
    ...
    function batchSwap(
        ...
        boofySwapper.swap(address(silo), address(native), amount);
