...
import { IBoofyOracle } from "../../interfaces/oracle/IBoofyOracle.sol";
import { BoofyOracleErrors } from "./BoofyOracleErrors.sol";

/// @title Boofy Oracle Helper
/// @author Beefy, @kexley
/// @notice Helper functions for Boofy oracles
library BoofyOracleHelper {
    ...
    /// @param _oracle Central Boofy oracle which stores the base token price
    ...
    function priceFromBaseToken(
        ...
        (uint256 basePrice,) = IBoofyOracle(_oracle).getFreshPrice(_baseToken);
