...
/**
 * @dev Interface of a Boofy Vault
 */
interface IVault {
...
/**
 * @title Boofy Wrapper ERC-4626
 * @author kexley
 * @notice Implementation for an ERC-4626 wrapper of a Boofy Vault
 * @dev Wrapped Boofy Vault tokens can be minted by deposit of the underlying asset or by 
 * wrapping Boofy Vault tokens in a 1:1 ratio. Wrapped Boofy Vault tokens can either be unwrapped
 * for an equal number of Boofy Vault tokens or redeemed for the underlying asset.
 ...
 */
contract BoofyWrapper is ERC4626Upgradeable {
    ...
    /**
     * @notice Initializes an ERC-4626 wrapper for a Boofy Vault token
