...
// File: contracts/BIFI/zap/BoofyUniV2Zap.sol
...
contract BoofyUniV2ZapSolidly {
    ...
    function _getVaultPair (address boofyVault) private pure returns (IBoofyVaultV6 vault, IUniswapV2Pair pair) {
