...
interface IBoofyVault is IERC20 {
    function deposit(uint256 amount) external;
    function withdraw(uint256 shares) external;
    function want() external pure returns (address); // Boofy Vault V6
    function token() external pure returns (address); // Boofy Vault V5
}

contract BoofyZapMdex {
    ...
    function _getVaultPair (address boofyVault) private view returns (IBoofyVault vault, IUniswapV2Pair pair) {
