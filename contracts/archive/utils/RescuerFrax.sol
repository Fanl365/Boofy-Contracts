...
contract RescuerFrax is Ownable {
    ...
    IBoofyVault public boofyVault = IBoofyVault(0xb8EddAA94BB8AbF8A5BB90c217D53960242e104D);
    ...
    function fraxNeeded() public view returns (uint256) {
        return boofyVault.balance() - frax.balanceOf(address(iToken));
    }
    ...
    function upgrade() external onlyOwner {
        ...
        // Start Flash Loan
        fraxPair.swap(0, fraxNeeded(), address(this), "BoofyRescue");
    }
