...
contract StrategyKyberCurve2Cad is StratManager, FeeManager {
    ...
    ) StratManager(_stratManager.keeper, _stratManager.strategist, _stratManager.unirouter, _stratManager.vault, _stratManager.boofyFeeRecipient) public {
        want = _want;
        poolId = _poolId;
        chef = _chef;
        jarvis = _jarvis;
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 boofyFeeAmount = nativeBal.mul(boofyFee).div(MAX_FEE);
