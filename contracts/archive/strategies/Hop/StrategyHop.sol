...
contract StrategyHop is StratFeeManagerInitializable {
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        uint256 boofyFeeAmount = nativeFeeBal * fees.boofy / DIVISOR;
    ...
    function _addLiquidity() internal {
        ...
        IBoofySwapper(unirouter).swap(depositToken, want, depositTokenBal);
    }
    ...
    function callReward() public view returns (uint256) {
        ...
        uint256 nativeOut = IBoofySwapper(unirouter).getAmountOut(reward, native, rewardBal);
