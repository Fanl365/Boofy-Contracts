...
contract StrategyDFYNDualFarmRewardPoolLP is StratManager, FeeManager {
    ...
    // Routes
    address[] public outputToNativeRoute; // since DFYN uses its own native, convert to common token, then convert that token to native boofy uses
    ...
    function chargeFees() internal {
        ...
        IERC20(wmatic).safeTransfer(boofyFeeRecipient, boofyFeeAmount);
