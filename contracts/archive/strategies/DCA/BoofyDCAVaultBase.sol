...
import "./BoofyERC721Enumerable.sol";

pragma solidity ^0.8.0;
contract BoofyDCAVaultBase is BoofyERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    // Deposit: Will Deposit into boofy vault and account for underlying deposited. It will mint a vault if you dont own one by passing through 0 as _id. 
