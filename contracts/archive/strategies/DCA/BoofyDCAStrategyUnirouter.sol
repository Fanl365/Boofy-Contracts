...
contract BoofyDCAStrategyUnirouter is Ownable, Pausable {
    ...
    // We send the funds to work in the underlying Boofy Vault. 
     ...
     // Withdraw: Converts amount requested from vault to shares and withdraws from Boofy Vault, sends the want withdrew to vault. 
