...
import "../../../archive/strategies/Balancer/BoofyBalancerStructs.sol";
...
contract StrategyBalancerMultiRewardChefUniV2 is StratFeeManagerInitializable {
    ...
    BoofyBalancerStructs.BatchSwapStruct[] public nativeToInputRoute;
    ...
    function initialize(
        ...
        BoofyBalancerStructs.BatchSwapStruct[] calldata _nativeToInputRoute,
        BoofyBalancerStructs.BatchSwapStruct[] calldata _outputToNativeRoute,
