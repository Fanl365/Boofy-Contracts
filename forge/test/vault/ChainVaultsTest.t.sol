...
contract ChainVaultsTest is Test {
    ...
    // address book data
    AddressBook.BoofyPlatform addressBookBoofy;
    ...
    function setUp() public {
        ...
        addressBookBoofy = ab.getBoofyPlatformConfig(chain);
    }
...
//        assertGt(callRewards, 0, "Expected callRewards > 0");
    ...
    function test_panic() external {
        ...
        vm.prank(addressBookBoofy.keeper);
        strategy.panic();
    ...
    function test_correctOwnerAndKeeper() external view {
        assertEq(vault.owner(), addressBookBoofy.vaultOwner, "Wrong vault owner.");
        assertEq(strategy.owner(), addressBookBoofy.strategyOwner, "Wrong strategy owner.");
        assertEq(strategy.keeper(), addressBookBoofy.keeper, "Wrong keeper.");
    }
