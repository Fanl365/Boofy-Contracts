...
contract AddressBookTest is Test {
    ...
    function test_BoofyPlatformConfig_ethereum() external {
        AddressBook.BoofyPlatform memory config = ab.getBoofyPlatformConfig("ethereum");
    ...
    function test_BoofyPlatformConfig_bsc() external {
        AddressBook.BoofyPlatform memory config = ab.getBoofyPlatformConfig("bsc");
