...
interface IStrategy {
    ...
    function boofyFee() external view returns (uint256);

    function boofyFeeRecipient() external view returns (address);

    function boofyFeeConfig() external view returns (address);
    ...
    function setBoofyFeeRecipient(address _boofyFeeRecipient) external;
