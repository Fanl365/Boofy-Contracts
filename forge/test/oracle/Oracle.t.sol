...
import { BoofyOracle } from "../../../contracts/BIFI/infra/BoofyOracle/BoofyOracle.sol";
import { BoofyOracleChainlink } from "../../../contracts/BIFI/infra/BoofyOracle/BoofyOracleChainlink.sol";
import { BoofyOracleUniswapV3 } from "../../../contracts/BIFI/infra/BoofyOracle/BoofyOracleUniswapV3.sol";
import { BoofyOracleUniswapV2 } from "../../../contracts/BIFI/infra/BoofyOracle/BoofyOracleUniswapV2.sol";
import { BoofyOracleSolidly } from "../../../contracts/BIFI/infra/BoofyOracle/BoofyOracleSolidly.sol";
import { BoofyOracleErrors } from "../../../contracts/BIFI/infra/BoofyOracle/BoofyOracleErrors.sol";

contract Oracle is Test {

    BoofyOracle public oracle;
    ...
    function setUp() public {
        oracle = new BoofyOracle();
        oracle.initialize();
    }

    function testSetChainlinkOracle() external {
        address chainlinkOracle = deployCode("BoofyOracleChainlink.sol");
    ...
    function testSetUniswapV3Oracle() external {
        ...
        address uniswapV3Oracle = deployCode("BoofyOracleUniswapV3.sol");
    ...
    function testSetUniswapV2Oracle() external {
        ...
        address uniswapV2Oracle = deployCode("BoofyOracleUniswapV2.sol");
    ...
    function testSetSolidlyOracle() external {
        ...
        address solidlyOracle = deployCode("BoofyOracleSolidly.sol");
    ...
    function testSetOracleNoBasePrice() external {
        ...
        address uniswapV3Oracle = deployCode("BoofyOracleUniswapV3.sol");
        vm.expectRevert(abi.encodeWithSelector(BoofyOracleErrors.NoBasePrice.selector, usdc));
        oracle.setOracle(eth, uniswapV3Oracle, usdcEthUniswapV3Feed);
    }
